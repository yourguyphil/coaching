    ...
    <Grid container spacing={4}>
        ...
        <Box data-aos={isMd ? 'fade-right' : 'fade-up'}>
          ...
          <Box marginBottom={3}>
            ...
            <Typography variant="h6" component="p" color="text.secondary">
              ...
              <br />
              Magic the Gathering Coaching, Riftbound Coaching, and Lorcana Coaching
            </Typography>
          </Box>
          <Box
            display="flex"
      ...
      >
        <Box
          ...
          alt="Master Class Magic The Gathering Coaching | Master Class Lorcana Coaching | Master Class Riftbound Coaching"
          effect="blur"
          boxShadow={3}
          borderRadius={2}
          maxWidth={600}
