    ...
    <Box>
      <Box marginBottom={4}>
        ...
        <Typography
          ...
          data-aos={'fade-up'}
        >
          Checkout my current availability and packages!
        </Typography>
            ...
            <CardContent sx={{ padding: { sm: 4 } }}>
              ...
              <Box marginBottom={4}>
                <Typography
                  ...
                  gutterBottom
                >
                  {pricingOption === 'annual' ? '60 min' : 'Biweekly 30 min'}
                </Typography>
        ...
        <Grid item container xs={12} md={6} alignItems={'center'}>
          <Box component={Card} bgcolor={theme.palette.primary.main}>
            ...
            >
              ...
              >
                Coaching sessions are crafted custom to your goals.
              </Typography>
              <Typography
                align={'center'}
                sx={{ color: theme.palette.common.white }}
              >
                Step by step action plans to reach your desired results.
              </Typography>
            </CardContent>
          </Box>
        </Grid>
