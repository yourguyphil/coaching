  ...
  return (
    <Box>
      <Typography variant="h2" align={'center'} fontWeight={700} gutterBottom>
        Pokemon Pocket Strategy Guide
      </Typography>
      <Typography variant="h6" align={'center'} color={'textSecondary'}>
          Welcome to my Pokémon TCG Pocket strategy guide - where we'll discuss strategies and tactics to push our game to the <b><i>next level</i></b>.
          <br></br>
          <br></br>
